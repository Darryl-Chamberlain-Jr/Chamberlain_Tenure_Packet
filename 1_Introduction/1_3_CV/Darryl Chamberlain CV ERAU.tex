...
\peerReviewedArticle{%
	Faulconer, E., Terwilliger, B., \textbf{Chamberlain Jr., D.}, Deters. R., \& Kam, C. (under review 2024). 
...
\presentations{
	...
	2023 Academic Innovation Virtual Conference hosted by ERAU-WW (virtual). 
}
\presentations{
	Faulconer, E.*, \textbf{Chamberlain Jr., D.*}, \& Wood, B.
	(2022, April 13). 
...
\cvitem{2025}{
	\textbf{Committee Member} for ERAU One-University ad hoc senate committee to develop core End-of-Course survey questions.
}
\cvitem{2024-2025}{
...
\cvitem{2022--present}{
	...
	\begin{itemize}
	\item Bachelor's Degree in Data Science (2024-present); 
