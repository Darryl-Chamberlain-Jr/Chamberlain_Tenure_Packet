...
\underReviewArticle{%
   Velez, M., \textbf{Chamberlain Jr., D.}, Reed, Z., \& Aydiner, C. 
   (abstract accepted May 2024, chapter submission Aug 2024).
...
\underReviewArticle{%
	Faulconer, E., Terwilliger, B., \textbf{Chamberlain Jr., D.}, Deters. R., \& Kam, C. (under review Apr 2024). 
...
\underReviewArticle{%
	...
	(initial submission Mar 2023, accepted for chapter submission Jul 2023, chapter draft submitted Nov 2023, chapter accepted pending minor revisions Feb 2024).
...
\cvitem{
	2022--present}
	{\textbf{Subcommittee Chair} for Mathematical Association of America Subcommittee on Technologies in Mathematics Education (STME). Member since 2021.}
