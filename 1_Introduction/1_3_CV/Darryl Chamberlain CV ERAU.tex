...
\newcounter{preprintCounter}
\newcommand{\preprint}[1]{%
	\stepcounter{preprintCounter}
	\cvitem{[\arabic{preprintCounter}]}{%
		#1
	}
}
...
\newcounter{localOrganizationCounter}
\newcommand{\localOrganization}[1]{%
	\stepcounter{localOrganizationCounter}
	\cvitem{[\arabic{localOrganizationCounter}]}{%
		#1
	}
}

% Counter for White Papers
\newcounter{whitePaperCounter}
\newcommand{\whitePaper}[1]{%
	\stepcounter{whitePaperCounter}
	\cvitem{[\arabic{whitePaperCounter}]}{%
		#1
	}
}

% Counter for Research Summary Documents
\newcounter{ResearchSummaryCounter}
\newcommand{\researchSummary}[1]{%
	\stepcounter{ResearchSummaryCounter}
	\cvitem{[\arabic{ResearchSummaryCounter}]}{%
		#1
	}
}
